...
describe "olympian API" do
  ...
  it "gets the youngest olympian" do
    ...
    expect(olympian["name"]).to eq(@olympian3.name)
    expect(olympian["team"]).to eq(@olympian3.team)
    expect(olympian["age"]).to eq(@olympian3.age)
    expect(olympian["sport"]).to eq(@olympian3.sport)
    expect(olympian["total_medals_won"]).to eq(@olympian3.total_medals_won)
  end
  ...
  it "gets the oldest olympian" do
    ...
    expect(olympian["total_medals_won"]).to be_a(Integer)
    expect(olympian["name"]).to be_a(String)
    expect(olympian["name"]).to eq(@olympian2.name)
    expect(olympian["team"]).to eq(@olympian2.team)
    expect(olympian["age"]).to eq(@olympian2.age)
